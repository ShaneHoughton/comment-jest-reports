...
import { readJsonFile, appendResultStr, reportFailures, reportLowCoverage } from "./helpers";
...
try {
  ...
  if (results.numFailedTests === 0 && results.numFailedTestSuites === 0) {
    ...
    appendResultStr(`* Only ${results.numPassedTests}/${results.numTotalTests} tests passed.`)
